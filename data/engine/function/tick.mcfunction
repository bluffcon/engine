...
execute as @e[type=fishing_bobber] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{movement:{horizontal_speed:0}}} at @s on origin if items entity @s weapon.* fishing_rod[custom_data~{engine:"redstone_pouch"},!damage=640] run function engine:pouch/redstone/redstone_pouch
execute as @e[type=fishing_bobber] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{movement:{horizontal_speed:0}}} at @s on origin if items entity @s weapon.* fishing_rod[custom_data~{engine:"torch_pouch"},!damage=640] run function engine:pouch/torch/torch_pouch
