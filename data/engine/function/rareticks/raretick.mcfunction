...
execute as @e[type=marker,tag=engine.blocks.block5] at @s if entity @e[type=end_crystal,distance=..10] if score @s engine.lava matches 32.. run function engine:blocks/block/block5/work
