...
give @s minecraft:bat_spawn_egg[item_name={"text":"Pressure Blower","italic":false},item_model="minecraft:resin_block",lore=[{"text":"Emits redstone signal for one second, then doesn't for one second","color":"gold","italic":false},{"text":"Incidentally, ticks whenever other Engine blocks tick themselves","color":"gray","italic":false},"",{"text":"Engine","color":"blue","italic":true}],custom_data={engine:"timed_ticker"},max_stack_size=64,entity_data={id:"minecraft:armor_stand",NoGravity:1b,Tags:["engine.blocks.block9","engine.blocks.all"],Invisible:1b}]

give @s lime_dye[item_model=potion,potion_contents={custom_color:11065694},tooltip_display={hidden_components:["potion_contents"]},item_name={"text":"Etching Solution",extra:[{text:" FeCl₃",color:yellow}]},custom_data={engine:"etching_solution"},lore=[{"color":"gold","italic":false,"text":"Used in an Etching Chamber to create PCB designs"},{"color":"gray","italic":false,"text":"Oxidizes copper into a state that makes is easily"},{"color":"gray","italic":false,"text":"dissolveable. Can make oxidized copper blocks"},"",{"color":"blue","italic":true,"text":"Engine"}]]
give @s minecraft:poisonous_potato[consumable={consume_seconds:3},item_model=white_dye,item_name={text:"Table Salt",extra:[{text:" NaCl",color:yellow}]},custom_data={engine:"salt"},lore=[{"color":"gold","italic":false,"text":"Sea salt from evaporated water"},{"color":"gray","italic":false,"text":"Can be eaten"},"",{"color":"blue","italic":true,"text":"Engine"}]]

give @s minecraft:poisonous_potato[!consumable,glider={},tooltip_display={hidden_components:["dyed_color"]},equippable={slot:chest,equip_on_interact:1b,swappable:1b,camera_overlay:"minecraft:gui/sprites/gamemode_switcher/slot",asset_id:"leather",equip_sound:"minecraft:block.iron_trapdoor.open"},damage=0,max_damage=512,max_stack_size=1,item_model=elytra,enchantment_glint_override=true,item_name={text:"Phantom Pennon",color:"#fee7e0"},dyed_color=16705504,lore=[{"color":"gold","italic":false,"text":"Reinforced wings of phantom membranes and metal rods"},{"color":"gray","italic":false,"text":"Handling requires safety goggles and firework rockets"},{"color":"gray","italic":false,"text":"Cannot be enchanted or repaired in an anvil"},"",{"color":"blue","italic":true,"text":"Engine"}]]
