summon marker ~ ~0.5 ~ {Tags:["engine.blocks.all","engine.blocks.block6","engine"]}

setblock ~ ~ ~ barrel[facing=up]{CustomName:"Magmatic Workbench",lock:{components:{"custom_data":{engine:"hammer"}}}}
