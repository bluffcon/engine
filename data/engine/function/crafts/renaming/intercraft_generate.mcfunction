data modify storage engine:crafting renaming.name set string storage engine:crafting 5.id
data modify storage engine:crafting renaming.nameshort set string storage engine:crafting 5.id 10

data modify storage engine:crafting renaming.isblock set value 0
execute store result storage engine:crafting renaming.isblock byte 1 run function engine:crafts/renaming/test_for_block with storage engine:crafting 5
...
function engine:crafts/renaming/craft_generate with storage engine:crafting renaming