execute if data storage engine:crafting 5.components."minecraft:custom_name".text run data modify storage engine:crafting renaming.name set from storage engine:crafting 5.components."minecraft:custom_name".text
execute unless data storage engine:crafting 5.components."minecraft:custom_name".text run data modify storage engine:crafting renaming.name set from storage engine:crafting 5.components."minecraft:custom_name"
...
data modify storage engine:crafting renaming.extras set value {"text": ""}
data modify storage engine:crafting renaming.extras2 set value {"text":" - :D"}
...
execute if data storage engine:crafting 8{id:"minecraft:dirt"} if data storage engine:crafting 5.components."minecraft:item_name".text run data modify storage engine:crafting renaming.extras set from storage engine:crafting 5.components."minecraft:item_name"
execute if data storage engine:crafting 8{id:"minecraft:dirt"} if data storage engine:crafting 5.components."minecraft:item_name".text run data modify storage engine:crafting renaming.extras2 set value {"text":" - ","color":"gray"}

execute if data storage engine:crafting 8{id:"minecraft:dirt"} unless data storage engine:crafting 5.components."minecraft:item_name" run function engine:crafts/renaming/generatetrans with storage engine:crafting renaming

function engine:crafts/renaming/craft with storage engine:crafting renaming