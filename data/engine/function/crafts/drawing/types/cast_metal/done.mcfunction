...
give @p paper[custom_data={enginebp:"cast_metal"},item_name={"text":"Whiteprint: Cast Metal",color:"#d2dff1"},item_model="minecraft:bordure_indented_banner_pattern",lore=[ \
...
function engine:crafts/drawing/success
